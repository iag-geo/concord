...
A [CSV file](https://minus34.com/opendata/geoscape-202505/boundary_concordance.csv) and supporting scripts for converting data between Australian boundaries.
...
Download & import the ~50Mb [concordance file](https://minus34.com/opendata/geoscape-202505/boundary_concordance.csv) into your database or reporting tool to [get started](#get-started). A [script](/postgres-scripts/00_import_concordance_file.sql) for importing into Postgres is also provided.
...
1. Tag all GNAF addresses with 2016 & 2021 ABS Census boundaries and geoscape 202505 Administrative boundaries
...
1. Download the [concordance file](https://minus34.com/opendata/geoscape-202505/boundary_concordance.csv)
...
1. The boundary from/to combination you need isn't in the standard [concordances file](https://minus34.com/opendata/geoscape-202505/boundary_concordance.csv)
...
3. You have a license of [Geoscape Buildings](https://geoscape.com.auhttps://minus34.com/opendata/geoscape-202505/boundary_concordance.csv/buildings/) or [Geoscape Land Parcels](https://geoscape.com.auhttps://minus34.com/opendata/geoscape-202505/boundary_concordance.csv/land-parcels/) and want to use the _planning zone_ data in those products to:
...
3. GNAF from gnaf-loader ([download](https://minus34.com/opendata/geoscape-202505/gnaf-202505.dmp))
4. Geoscape Administrative Boundaries from gnaf-loader ([download](https://minus34.com/opendata/geoscape-202505/admin-bdys-202505.dmp))
...
Incorporates or developed using G-NAF © [Geoscape Australia](https://geoscape.com.au/legalhttps://minus34.com/opendata/geoscape-202505/boundary_concordance.csv-copyright-and-disclaimer/) licensed by the Commonwealth of Australia under the [Open Geo-coded National Address File (G-NAF) End User Licence Agreement](https:/https://minus34.com/opendata/geoscape-202505/boundary_concordance.csv.gov.auhttps://minus34.com/opendata/geoscape-202505/boundary_concordance.csvset/ds-dga-19432f89-dc3a-4ef3-b943-5326ef1dbecc/distribution/dist-dga-09f74802-08b1-4214-a6ea-3591b2753d30/details?q=).

Incorporates or developed using Administrative Boundaries © [Geoscape Australia](https://geoscape.com.au/legalhttps://minus34.com/opendata/geoscape-202505/boundary_concordance.csv-copyright-and-disclaimer/) licensed by the Commonwealth of Australia under [Creative Commons Attribution 4.0 International licence (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/).

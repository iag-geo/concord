...
from census_2026_bdys.mb_2026_aust
;
analyse temp_mb;
...
inner join census_2026_bdys.ced_2026_aust as bdy on st_intersects(temp_mb.geom, bdy.geom);
analyse temp_ced_mb;
...
inner join census_2026_bdys.lga_2026_aust as bdy on st_intersects(temp_mb.geom, bdy.geom);
analyse temp_lga_mb;
...
inner join census_2026_bdys.poa_2026_aust as bdy on st_intersects(temp_mb.geom, bdy.geom);
analyse temp_poa_mb;
...
inner join census_2026_bdys.ra_2026_aust as bdy on st_intersects(temp_mb.geom, bdy.geom);
analyse temp_ra_mb;
...
inner join census_2026_bdys.sed_2026_aust as bdy on st_intersects(temp_mb.geom, bdy.geom);
analyse temp_sed_mb;
...
inner join census_2026_bdys.ucl_2026_aust as bdy on st_intersects(temp_mb.geom, bdy.geom);
analyse temp_ucl_mb;
...
from gnaf.address_principals as adr
     inner join abs on abs.mb_code16 = adr.mb_2026_code::text
;
...
-- select count(*) from gnaf.address_principal_census_2026_boundaries; -- 14,488,752

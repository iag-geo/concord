...
from census_2021_bdys_gda94.correspondences_sa2 as cor
         inner join gnaf_202502.boundary_concordance as bdy on bdy.from_id = cor.sa2_maincode_2016
...
with agg as (
    ...
    from gnaf_202502.address_principal_census_2016_boundaries as f
        inner join gnaf_202502.address_principal_census_2021_boundaries as t on t.gnaf_pid = f.gnaf_pid

...
select count(*)
from admin_bdys_202308.abs_2021_sa2;


select *
from gnaf_202308.boundary_concordance
where from_bdy = 'postcode'
and to_bdy = 'poa';


select *
from admin_bdys_202308.abs_2016_sa1;


select *
from gnaf_202308.address_principal_census_2016_boundaries;
...
select *
from admin_bdys_202308.abs_2016_mb as adm
...
select mb.*
from admin_bdys_202308.abs_2021_mb as mb
inner join admin_bdys_202308.postcode_bdys as pc on st_intersects(mb.geom, pc.geom)
-- inner join admin_bdys_202308.postcode_bdys as pc on st_intersects(st_centroid(mb.geom), pc.geom)

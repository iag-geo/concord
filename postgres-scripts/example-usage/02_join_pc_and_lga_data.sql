...
--
-- -- concordance table
-- select * from gnaf_202305.boundary_concordance;
...
WITH pc_data AS (
    ...
    INNER JOIN gnaf_202305.boundary_concordance AS con ON pc.postcode = con.from_id
    WHERE con.from_source = 'geoscape 202305'
...
WHERE from_source = 'geoscape 202305'

...
# sample arguments
#python3 /Users/$(whoami)/git/iag_geo/concord/create_concordance_file.py --admin-schema="admin_bdys_202205" --output-schema="gnaf_202205" --output-path=${OUTPUT_FOLDER}

...
python3 /Users/$(whoami)/git/iag_geo/concord/create_concordance_file.py --pgdb=geo --admin-schema="admin_bdys_202602_gda2020" --gnaf-schema="gnaf_202602_gda2020" --output-path=${OUTPUT_FOLDER_2020}

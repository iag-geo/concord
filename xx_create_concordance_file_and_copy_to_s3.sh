...
# sample arguments
#python3 /Users/$(whoami)/git/iag_geo/concord/create_concordance_file.py --admin-schema="admin_bdys_202202" --output-schema="gnaf_202202" --output-path=${OUTPUT_FOLDER}

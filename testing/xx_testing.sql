...
from gnaf_202302.address_principal_admin_boundaries as bdy
inner join gnaf_202302.address_principals as gnaf on gnaf.gnaf_pid = bdy.gnaf_pid
inner join admin_bdys_202302.abs_2016_mb as mb on mb.mb_16code = gnaf.mb_2016_code
...
select *
from gnaf_202302.address_alias_admin_boundaries
;

select *
from admin_bdys_202302.abs_2016_mb
;

select * from admin_bdys_202302.local_government_areas
order by name, state;

...
from gnaf_202602.address_principal_admin_boundaries as bdy
         inner join gnaf_202602.address_principals as gnaf on gnaf.gnaf_pid = bdy.gnaf_pid
group by bdy.state,
         bdy.lga_name,
         bdy.postcode,
         bdy.locality_name
...
from gnaf_202602.address_principal_admin_boundaries as bdy
inner join gnaf_202602.address_principals as gnaf on gnaf.gnaf_pid = bdy.gnaf_pid
inner join admin_bdys_202602.abs_2016_mb as mb on mb.mb_16code = gnaf.mb_2016_code
...
select *
from admin_bdys_202602.abs_2016_mb
;

select * from admin_bdys_202602.local_government_areas
order by name, state;

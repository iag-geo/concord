...
from gnaf_202305.address_principal_admin_boundaries as bdy
inner join gnaf_202305.address_principals as gnaf on gnaf.gnaf_pid = bdy.gnaf_pid
inner join admin_bdys_202305.abs_2016_mb as mb on mb.mb_16code = gnaf.mb_2016_code
...
select *
from gnaf_202305.address_alias_admin_boundaries
;

select *
from admin_bdys_202305.abs_2016_mb
;

select * from admin_bdys_202305.local_government_areas
order by name, state;

...
from gnaf_202205.address_principal_admin_boundaries as target
inner join gnaf_202205.address_principals as source on source.gnaf_pid = target.gnaf_pid
;
...
from gnaf_202205.address_principal_admin_boundaries as psma
...
--        postcode,
--        state
-- from temp_bdy_concordance as tmp, gnaf_202205.address_principal_admin_boundaries as psma
-- where psma.gnaf_pid = tmp.gnaf_pid
--     and target_id is null
